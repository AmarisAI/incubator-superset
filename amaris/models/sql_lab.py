...
from amaris import security_manager
from amaris.models.helpers import AuditMixinNullable
from amaris.utils import QueryStatus, user_label
...
class Query(Model):
    ...
    # Could be configured in the amaris config.
...
class SavedQuery(Model, AuditMixinNullable):
    ...
    def pop_tab_link(self):
        return Markup("""
            <a href="/amaris/sqllab?savedQueryId={self.id}">
