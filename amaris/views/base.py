...
from amaris import conf, security_manager, utils
from amaris.translations.utils import get_language_pack
...
class SupersetListWidget(ListWidget):
    template = 'amaris/fab_overrides/list.html'
...
class ListWidgetWithCheckboxes(ListWidget):
    ...
    template = 'amaris/fab_overrides/list_with_checkboxes.html'
