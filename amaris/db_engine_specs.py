...
from amaris import app, cache_util, conf, db, utils
from amaris.exceptions import SupersetTemplateException
from amaris.utils import QueryStatus
...
class HiveEngineSpec(PrestoEngineSpec):
    ...
    def patch(cls):
        ...
        from amaris.db_engines import hive as patched_hive
