...
from amaris import utils
from amaris.models.core import Slice
from amaris.models.helpers import AuditMixinNullable, ImportMixin
...
class BaseDatasource(AuditMixinNullable, ImportMixin):
    ...
    def explore_url(self):
        if self.default_endpoint:
            ...
            return '/amaris/explore/{obj.type}/{obj.id}/'.format(obj=self)
    ...
    def query(self, query_obj):
        ...
        query_obj is a dictionary representing amaris's query interface.
