...
from amaris import config, utils
from amaris.connectors.connector_registry import ConnectorRegistry
from amaris.security import SupersetSecurityManager

APP_DIR = os.path.dirname(__file__)
CONFIG_MODULE = os.environ.get('SUPERSET_CONFIG', 'amaris.config')
...
class MyIndexView(IndexView):
    @expose('/')
    def index(self):
        return redirect('/amaris/welcome')
