...
from amaris.stats_logger import DummyStatsLogger
...
SQLALCHEMY_DATABASE_URI = 'sqlite:///' + os.path.join(DATA_DIR, 'amaris.db')
...
APP_ICON = '/static/assets/images/amaris-logo@2x.png'
...
BABEL_DEFAULT_FOLDER = 'amaris/translations'
...
SMTP_MAIL_FROM = 'amaris@amaris.com'
