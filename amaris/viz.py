...
from amaris import app, cache, get_manifest_file, utils
from amaris.exceptions import NullValueException
from amaris.utils import DTTM_ALIAS, JS_MAX_INTEGER, merge_extra_filters
...
class TableViz(BaseViz):
    ...
    credits = 'a <a href="https://github.com/airbnb/amaris">Superset</a> original'
    is_timeseries = False
...
class MultiLineViz(NVD3Viz):
    ...
    def get_data(self, df):
        ...
        from amaris.models.core import Slice
...
class WorldMapViz(BaseViz):
    ...
    def get_data(self, df):
        from amaris.data import countries
        fd = self.form_data
        cols = [fd.get('entity')]
        metric = self.get_metric_label(fd.get('metric'))
        secondary_metric = self.get_metric_label(fd.get('secondary_metric'))
